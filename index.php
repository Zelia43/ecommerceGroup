...
<meta name="viewport" content="width=device-width, initial-scale=1">
        ...
        <div class="header">
                ...
                <div class="container">
                    ...
                    <div class="logo">
                        <h1 ><a href="index.html"></b>LooZeeLee<span style="color:green">Act Transform Sustain</span></a></h1>
                    </div>
    
                    <div class="head-t">
                        <ul class="card">
                            <li><a href="wishlist.html" ><i class="fa fa-heart" aria-hidden="true"></i>Wishlist</a></li>
                            <li><a href="view/login.php" ><i class="fa fa-user" aria-hidden="true"></i>Login</a></li>
                            <li><a href="view/register.php" ><i class="fa fa-arrow-right" aria-hidden="true"></i>Register</a></li>
									...
									<div class="row">
										<div class="col-sm-3">
											<ul class="multi-column-dropdown">
												<li><a href="kitchen.html"><i class="fa fa-angle-right" aria-hidden="true"></i>Fabrics</a></li>
												<li><a href="kitchen.html"><i class="fa fa-angle-right" aria-hidden="true"></i>Sewn Fabrics</a></li>	
												<li><a href="kitchen.html"><i class="fa fa-angle-right" aria-hidden="true"></i>Kimono</a></li>
											</ul>										
										</div>
										<div class="col-sm-3 w3l">
											<a href="kitchen.html"><img src="images/cloth.jpeg" class="img-responsive" alt=""></a>
										</div>
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu multi multi2">
									<div class="row">
										<div class="col-sm-3">
											<ul class="multi-column-dropdown">
												<li><a href="hold.html"><i class="fa fa-angle-right" aria-hidden="true"></i>Weaved Bags</a></li>
												<li><a href="hold.html"><i class="fa fa-angle-right" aria-hidden="true"></i>Leather</a></li>										
											</ul>
										</div>		
										<div class="col-sm-3 w3l">
											<a href="hold.html"><img src="images/bag.jpg" class="img-responsive" alt=""></a>
										</div>
										<div class="clearfix"></div>
									</div>	
								</ul>
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu multi multi2">
									<div class="row">
										<div class="col-sm-3">
											<ul class="multi-column-dropdown">
												<li><a href="hold.html"><i class="fa fa-angle-right" aria-hidden="true"></i>Unrefined Shea Butter</a></li>
												<li><a href="hold.html"><i class="fa fa-angle-right" aria-hidden="true"></i>Processed Shea Butter</a></li>
											</ul>
										</div>

										<div class="col-sm-3 w3l">
											<a href="hold.html"><img src="images/shea.jpg" class="img-responsive" alt=""></a>
										</div>
										<div class="clearfix"></div>
									</div>	
								</ul>
						...
						<div class=" con-w3l">
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal5" class="offer-img">
										<img src="images/kimono1.jpeg" class="img-responsive" alt="">
										<div class="offer"><p><span>Offer</span></p></div>
									</a>
									<div class="mid-1">
										<div class="women">
											<h6><a href="single.html">Lays</a></h6>							
										</div>
										<div class="mid-2">
							...
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal6" class="offer-img">
										<img src="images/kimono2.jpg" class="img-responsive" alt="">
										<div class="offer"><p><span>Offer</span></p></div>
									</a>
									<div class="mid-1">
										<div class="women">
											<h6><a href="single.html">Kurkure</a></h6>							
										</div>
										<div class="mid-2">
											<p ><label>$150.00</label><em class="item_price">$120.00</em></p>
											  <div class="block">
												<div class="starbox small ghosting"> </div>
											</div>
											<div class="clearfix"></div>
							...
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal7" class="offer-img">
										<img src="images/kimono3.jpg" class="img-responsive" alt="">
										<div class="offer"><p><span>Offer</span></p></div>
									</a>
									<div class="mid-1">
										<div class="women">
											<h6><a href="single.html">Pop</a></h6>							
										</div>
										<div class="mid-2">
											<p ><label>$200.00</label><em class="item_price">$150.00</em></p>
											  <div class="block">
							...
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="single.html">Nuts</a></h6>							
										</div>
										<div class="mid-2">
											<p ><label>$250.00</label><em class="item_price">$200.00</em></p>
											  <div class="block">
												<div class="starbox small ghosting"> </div>
											</div>
											<div class="clearfix"></div>
